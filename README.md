...
<h4>Experience in developing the Decentralized Blockchain application using Ethereum.\n<b>Senior Web Developer<b/>, developing the Applications using <b>MERN</b>. </h4>
